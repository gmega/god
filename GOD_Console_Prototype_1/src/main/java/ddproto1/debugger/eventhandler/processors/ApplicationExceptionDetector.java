...
public class ApplicationExceptionDetector extends AbstractEventProcessor{
    ...
    public void specializedProcess(Event e) {
        ...
        IJavaNodeManager vmm = (IJavaNodeManager)vmmf.getNodeManager((String) exEvent
                .request().getProperty(DebuggerConstants.VMM_KEY)).getAdapter(IJavaNodeManager.class);
