 ...
 * @deprecated
 */
public class JVMShellLauncher implements IApplicationLauncherOld {

    private static final Logger logger = MessageHandler.getInstance().getLogger(JVMShellLauncher.class);
    ...
    public void launch() throws CommException, LauncherException, ConfigException {
        try{
            ...
            String cmdline = script
                    ...
                    + globalAddress + ":" + jvmport + " " + vmParameters 
    ...
    public IStreamManager getStreamManager() throws InvalidStateException{
        if(sht == null) throw new InvalidStateException("Cannot get manager. Application not yet launched.");
        return sht;
    }
}
