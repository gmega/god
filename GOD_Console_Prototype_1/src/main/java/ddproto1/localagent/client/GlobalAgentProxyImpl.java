 ...
 *
 */
public class GlobalAgentProxyImpl implements IGlobalAgent{
    ...
    public GlobalAgentProxyImpl(IConnectionManager icmgr, byte localgid){
        this.icmgr = icmgr;
    ...
    public void asyncNotify(Event e) 
    	throws CommException
    {
        throw new UnsupportedException("Asynchronous notifications are not yet supported.");
