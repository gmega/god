...
public class SpecLoader implements ISpecLoader, IConfigurationConstants{
    ...
    private static final Logger logger = MessageHandler.getInstance().getLogger(SpecLoader.class);
        ...
        throws IOException, SAXException
    {
        ...
        try{
            ...
            specMap = null;
            throw new SAXException("TOC URI contains an unrecognized protocol", ex);
        }
    }
        ...
        throws SpecNotFoundException
    {
        ...
        for(String urlspec : specLocations){
            try{
                ...
                logger.error("Failed to browse url " + urlspec, ex);
            }
        }
