...
public class ObjectSpecTypeImpl implements IObjectSpecType, ISpecQueryProtocol{
    ...
    public ObjectSpecTypeImpl(String incarnableType, String type,
        ...
        this.intfs = Collections.unmodifiableSet(new HashSet<Class>(intfs));
    ...
    public Set <Class> getSupportedInterfaces(){
        return intfs;
    }
    ...
    public boolean removeAttribute(String attributeKey) 
    {
        ...
        if(requiredAttributes.containsKey(attributeKey)){
            ...
            for(BranchKey bk : attributeBranches.get(attributeKey)){
    ...
    public IIntegerInterval computeResultingChildrenConstraints(
        ...
        Iterable <BranchKey>iterable = optionalChildren.get(xmlType);
    ...
    public Set<String> allSupportedChildrenTypes(Map<String, String> attValues){
        ...
        for(String childType : optionalChildren.keySet()){
            Iterable<BranchKey> branches = optionalChildren.get(childType);
    ...
    private static final AtomicInteger iCount = new AtomicInteger(0);
    ...
    private class ObjectSpecInstance implements IObjectSpec, IContextSearchable,  Cloneable {
        ...
        private String getFromContext(String key) throws IllegalAttributeException, UninitializedAttributeException{
            ...
            for(IObjectSpec parent : lookupStrategy.iterableWithRoot(this)){
                try{
                    ObjectSpecInstance impl = (ObjectSpecInstance)
                        parent.getAdapter(ObjectSpecInstance.class);
            ...
            throws IllegalAttributeException
        {
            ...
            IContextSearchable searchableChild = (IContextSearchable)spec.getAdapter(IContextSearchable.class);
        ...
        public boolean removeChild(IObjectSpec spec) throws IllegalAttributeException{
            ...
            if(searchableChild != null){
                try{
                    searchableChild.removeParent(this);
                }catch(NoSuchSymbolException ex){
                    throw new RuntimeException("Inconsistency detected." + ex.getMessage(), ex);
                }
            }
