...
public class AbstractMultiMapTest extends TestCase {
    ...
    private AbstractMultiMap<String, String> omp = new OrderedMultiMap<String, String>(LinkedList.class);
    private AbstractMultiMap<String, String> ump = new UnorderedMultiMap<String, String>(HashSet.class);
    ...
    public void testKeySet() {
        ...
        Iterator it = ump.getClass("1").iterator();
        while(it.hasNext()){
            it.next();
            it.remove();
        }
