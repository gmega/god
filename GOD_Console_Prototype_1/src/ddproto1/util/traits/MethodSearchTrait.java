 ...
 *
 */
public class MethodSearchTrait {
    private static MethodSearchTrait instance;
    
    public static synchronized MethodSearchTrait getInstance(){
        return (instance == null)?(instance = new MethodSearchTrait()):instance;
    }
